 ...
 * of the pages - e.g. on the `<body>` or `<html>` tags.
 *
...
function $AnchorScrollProvider() {
   ...
   * positioned elements at the top of the pages, such as navbars, headers etc.
   *
   ...
   *   the top of the pages to the element's bottom will be used as offset.<br />
  ...
  this.$get = ['$window', '$location', '$rootScope', function($window, $location, $rootScope) {
    ...
    function scrollTo(elem) {
      if (elem) {
        ...
        if (offset) {
          ...
          // top of the viewport.
          //
          // IF the number of pixels from the top of `elem` to the end of the pages's content is less
          // than the height of the viewport, then `elem.scrollIntoView()` will align the `elem` some
          // way down the pages.
          //
          // This is often the case for elements near the bottom of the pages.
          //
    ...
    function scroll() {
      ...
      // empty hash, scroll to the top of the pages
      ...
      // no element and hash == 'top', scroll to the top of the pages
...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  this.$get = ['$$q', '$$asyncCallback', '$rootScope', function($$q, $$asyncCallback, $rootScope) {
     ...
     * ngAnimate module pages} as well as the {@link ngAnimate.$animate ngAnimate $animate service
     * pages}.
     */
    return {
...
function LocationHashbangInHtml5Url(appBase, hashPrefix) {
  ...
  this.$$compose = function() {
    ...
    this.$$url = encodePath(this.$$path) + (search ? '?' + search : '') + hash;
    // include hashPrefix in $$absUrl when $$url is empty so IE8 & 9 do not reload pages because of removal of '#'
   ...
   <example module="logExample">
     ...
     <file name="index.html">
       <div ng-controller="LogController">
         <p>Reload this pages with open console, enter text and hit the log button...</p>
         Message:
 ...
 *
 * For the general details about this service in Angular, read the main pages for {@link ng.$sce
...
function $$TestabilityProvider() {
  this.$get = ['$rootScope', '$browser', '$location',
     ...
     *
     * @description
     * Shortcut for navigating to a location without doing a full pages reload.
     *
 ...
 * without changing the location or causing pages reloads, e.g.:
    ...
    <example>
      ...
      <file name="protractor.js" type="protractor">
        ...
        it('should execute ng-click and change url when ng-href specified', function() {
          ...
          // At this point, we navigate away from an Angular pages, so we need
          ...
          }, 5000, 'pages should navigate to /123');
        });
        ...
        it('should only change url when only ng-href', function() {
          ...
          }, 5000, 'pages should navigate to /6');
        });
      </file>
    </example>
 */
 ...
 * pages reload that sends the data to the server. Instead some javascript logic should be triggered
        ...
        return {
          pre: function ngFormPreLink(scope, formElement, attr, controller) {
            ...
            if (!('action' in attr)) {
              ...
              // pages reload if the form was destroyed by submission of the form via a click handler
 ...
 * element attribute, it makes the bindings invisible to the user while the pages is loading.
 *
 ...
 * multiple `ngCloak` directives to small portions of the pages to permit progressive rendering
 * of the browser view.
 *
  ...
  * @example
      ...
      <example name="example.csp" module="cspExample" ng-csp="true">
        ...
        <file name="protractor.js" type="protractor">
          ...
          // as Safari does not load the pages with Protractor's injected scripts,
          // and Firefox webdriver always disables content security policy (#6358)
          if (browser.params.browser !== 'chrome') {
            return;
          }

          it('should not report errors when the pages is loaded', function() {
            // clear errors so we are not dependent on previous tests
            clearErrors();
            // Need to reload the pages as the pages is already loaded when
            // we come here
 ...
 * server and reloading the current pages), but only if the form does not contain `action`,
 ...
 * ```css
 * //
 * //a working example can be found at the bottom of this pages
 * //
