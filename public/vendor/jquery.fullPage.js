	...
	$.fn.fullpage = function(options) {
		...
		$.fn.fullpage.setAutoScrolling = function(value){
			...
			if(options.autoScrolling){
				...
				//scrolling the pages to the section with no animation
		...
		* As we are changing the top property of the pages on scrolling, we can not use the traditional way to detect it.
		...
		*/
		function scrollPage(element, callback, isMovementUp){
			...
			//more than once if the pages is scrolling
			isMoving = true;
		...
		*/
		...
		$(document).keydown(function(e) {
			//Moving the main pages with the keyboard arrows if keyboard scrolling is enabled
		...
		*/
		function destroyStructure(){
			...
			//scrolling the pages to the top with no animation
